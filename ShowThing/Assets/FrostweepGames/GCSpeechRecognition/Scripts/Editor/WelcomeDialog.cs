...
namespace FrostweepGames.Plugins.GoogleCloud.Translation
{
    ...
    public class WelcomeDialog : EditorWindow
    {
        ...
        [MenuItem("Window/Frostweep Games/Google Cloud/Translation")]
        private static void Init()
        {
            if (_Inited)
                return;

            WelcomeDialog window = (WelcomeDialog)GetWindow(typeof(WelcomeDialog), false, "Translation", true);
		...
		private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Welcome to Frostweep Games - Google Cloud Translation!", EditorStyles.boldLabel);
            ...
            if (GUILayout.Button("Locate Google Cloud Translation Settings"))
            {
            ...
            {
                System.Diagnostics.Process.Start(Application.dataPath + "/FrostweepGames/GCTranslation/Documentation.pdf");
            }
            if (GUILayout.Button("Open README"))
            {
                System.Diagnostics.Process.Start(Application.dataPath + "/FrostweepGames/GCTranslation/README.txt");
            }
